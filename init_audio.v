...
module  init_audio_meminit_f1k
	...
	defparam
		...
		addr_ctr.lpm_modulus = 8192,
		addr_ctr.lpm_port_updown = "PORT_UNUSED",
		addr_ctr.lpm_width = 13,
...
endmodule //init_audio_meminit_f1k
//VALID FILE
...
module init_audio (
	...
	wire [12:0] ram_address = sub_wire2[12:0];
	wire  ram_wren = sub_wire3;

	init_audio_meminit_f1k	init_audio_meminit_f1k_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
